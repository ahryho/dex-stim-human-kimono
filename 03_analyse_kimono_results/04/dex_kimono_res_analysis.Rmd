...
| :-------------- | :--------------------------- |:------------------------------- | :------------------------------------------------ | :-------------------- | :--------------------- |:--------------------------------------------------| 
| GEX             | 2,444                         | 2,759                          | Sex, Age, BMI, <br /> MDD, BCC                    | 0.01                  | 0.2                    | for kimono input, values are chosen based on pFDR |
| DNAm            | 3,560                         |                                | Sex, Age, BMI, <br /> MDD, BCC, PC<sub>1,2</sub>  | 0.05                  | 0.0                    | only DMPs                                         |
| SNP             | 100,149 <br /> &nbsp;        |                                 |                                                   |                       |                        |                                                   |
| Pheno           | 8                            |                                 |                                                   |                       |                        | Sex, Age, SV<sub>1-3</sub>, PC<sub>1,2</sub>      |
...
# kimono.res.fn   <- paste0(data.dir.pre, "output_04/kimono_res_dex.csv") # experiment nr 4
...
unique(network, by = c("relation", "predictor")) %>% 
  ggplot(., aes(relation)) + 
    ...
    labs(title = "Nr of relations for predictors")
...
network[relation == "snp_expr", predictor] %>% unique %>% head
