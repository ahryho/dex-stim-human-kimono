...
kimono.res.fn <- paste0(data.dir.pre, "output_04/kimono_res_dex.csv")
###############################################
### 2 Data
###############################################
# read in data
...
layer.gex    <- fread(paste0(data.dir.pre, "input_04/gex_dex.csv"))
layer.methyl <- fread(paste0(data.dir.pre, "input_04/methylation_beta_mtrx_dex.csv"))
layer.snp    <- fread(paste0(data.dir.pre, "input_04/snp_dex.csv"))
layer.pheno  <- fread(paste0(data.dir.pre, "input_04/pheno_dex.csv"))
